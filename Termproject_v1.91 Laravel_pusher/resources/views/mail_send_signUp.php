...
require_once('js/PHPMailer/PHPMailerAutoload.php');
	...
	$mail = new PHPMailer(); 
		...
		$mail->Username = "tntwkaps"; 
		  
		$mail->Password = "tntwkaps1!"; 
		  
		$mail->setFrom('tntwkaps@naver.com', $mail_from); 
		  
		$mail->addReplyTo('tntwkaps@naver.com', $mail_from); 
