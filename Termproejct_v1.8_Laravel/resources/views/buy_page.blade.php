		...
		$(document).ready(function(){
            ...
            $(".seat").click(function(){
            	...
            	if($(this).hasClass('disable')){
	            	...
	            	$("#userSelect").append('<input id="'+id+'" name="seat[]" class="fake" value="'+$(this).html()+'"></input>');
	            	cnt++;
	            	$("#cnt").val(cnt);
	            	$("#price").val(cnt*price);
            	}
			...
			function change_seats(){
			    $.get("buy_loadMoreData", {num:board_num, day:$("#day").val(), price:price, cnt:cnt}, function(data){
			    	$("#seatsFrom").html('');
	...
	<form action="buy" method="POST">
		...
		<div class="jumbotron" style="width: 90%; margin: 0 auto;">
			...
			<div style="display: flex; display:flex; margin: 0 auto; justify-content: center;">
				...
				<div style="width: 600px; height: 800px; border: 1px solid black;" id="select">
