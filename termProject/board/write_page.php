<?php
  ...
  $user_name = getSessionUid();

  $user_profile = $mdao->getProfile($user_name);
...
?>
      ...
      <div id="viewingClass_form">
        ...
        <label for="profile">Poster Select</label>	<!--공연 포스터-->
          <div id="imgSelect">
            <input type="file" id="profile_picture" name="board_picture" class="btn btn-primary" value="<?= $board_info['board_picture']?>" accept=".jpg, .jpeg, .png, .gif">
            <div id="preview">
