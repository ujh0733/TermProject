      ...
      <tbody>
       <?php
          ...
          foreach($board_info as $row){
            ...
            $board_opener = $row['board_opener'];
            $board_title = $row['board_title'];
            $board_posted = $row['board_posted'];
            $board_viewed = $row['board_viewed'];
            ...
            echo "<tr scope='row' onclick=location.href='board_view_cnt.php?board_num=$row[board_num]'>";
              echo "<td>$board_num</td>";
              echo "<td>$board_opener</td>";
              echo "<td>$board_title</td>";
              echo "<td>$board_posted</td>";
              echo "<td>$board_viewed</td>";
            echo "</tr>";
          }
       ?>
      </tbody>
